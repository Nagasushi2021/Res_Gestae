...
function loadAIDifficulties()
{
	return [
		...
		{
			"Name": "1000-",
			"Title": translateWithContext("aiDiff", "1000-")
		},
		{
			"Name": "1000-1200",
			"Title": translateWithContext("aiDiff", "1000-1200")
		},
		{
			"Name": "1200-1300",
			"Title": translateWithContext("aiDiff", "1200-1300"),
			"Default": true
		},
		{
			"Name": "1300-1400 (Standard)",
			"Title": translateWithContext("aiDiff", "1300-1400 (Standard)")
		},
		{
			"Name": "1400-1500",
			"Title": translateWithContext("aiDiff", "1400-1500")
		},
                {
			"Name": "1500-1600",
			"Title": translateWithContext("aiDiff", "1500-1600")
		},
                {
			"Name": "1600-1700",
			"Title": translateWithContext("aiDiff", "1600-1700")
		},
                {
			"Name": "1700-1800",
			"Title": translateWithContext("aiDiff", "1700-1800")
		}
	];
}
