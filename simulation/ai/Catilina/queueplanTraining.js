CATILINA.TrainingPlan = function(gameState, type, metadata, number = 1, maxMerge = 5)
{
...
CATILINA.TrainingPlan.prototype = Object.create(CATILINA.QueuePlan.prototype);

CATILINA.TrainingPlan.prototype.canStart = function(gameState)
{
...
CATILINA.TrainingPlan.prototype.getBestTrainers = function(gameState)
{
...
CATILINA.TrainingPlan.prototype.start = function(gameState)
{
	if (this.metadata && this.metadata.trainer)
	{
		let metadata = {};
...
CATILINA.TrainingPlan.prototype.addItem = function(amount = 1)
{
	this.number += amount;
};

/** Find the promoted types corresponding to this.type */
CATILINA.TrainingPlan.prototype.promotedTypes = function(gameState)
{
	let types = [];
...
CATILINA.TrainingPlan.prototype.Serialize = function()
{
	return {
...
CATILINA.TrainingPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
