...
function InitGame(settings)
{
	...
	// Sandbox, 1000-, 1000-1200, 1200-1300, 1300-1400(Standard), 1400-1500, 1500-1600, 1600-1700, 1700-1800
	...
	let rate = [ 0.42, 0.56, 0.75, 0.85, 1.00, 1.20, 1.40, 1.60, 1.80 ];
	let time = [ 1.40, 1.25, 1.10, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00 ];
