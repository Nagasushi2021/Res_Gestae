...
CATILINA.answerRequestAttackMessages = {
	"join": [
...
CATILINA.requestTributeMessages = [
...
CATILINA.newTradeRouteMessages = [
...
CATILINA.answerDiplomacyRequestMessages = {
	"ally": {
		"decline": [
...
CATILINA.sendDiplomacyRequestMessages = {
	"ally": {
		"sendRequest": [
...
CATILINA.chatLaunchAttack = function(gameState, player, type)
{
...
CATILINA.chatAnswerRequestAttack = function(gameState, player, answer, other)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatSentTribute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatRequestTribute = function(gameState, resource)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatNewTradeRoute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatNewPhase = function(gameState, phase, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatNewDiplomacy = function(gameState, player, newDiplomaticStance)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatAnswerRequestDiplomacy = function(gameState, player, requestType, response, requiredTribute)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
CATILINA.chatNewRequestDiplomacy = function(gameState, player, requestType, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/msg " + gameState.sharedScript.playersData[player].name + " " +
