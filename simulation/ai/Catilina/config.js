CATILINA.Config = function(difficulty, behavior)
{
...
CATILINA.Config.prototype.setConfig = function(gameState)
{
	...
	// Catilina usually uses the continuous values of personality.aggressive and personality.defensive
	...
	if (this.debug < 2)
		return;
	API3.warn(" >>>  Catilina bot: personality = " + uneval(this.personality));
};

CATILINA.Config.prototype.Serialize = function()
{
	var data = {};
	for (let key in this)
...
CATILINA.Config.prototype.Deserialize = function(data)
{
	for (let key in data)
		this[key] = data[key];
};
