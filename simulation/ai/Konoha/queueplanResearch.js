KONOHA.ResearchPlan = function(gameState, type, rush = false)
{
	if (!KONOHA.QueuePlan.call(this, gameState, type, {}))
		return false;
...
KONOHA.ResearchPlan.prototype = Object.create(KONOHA.QueuePlan.prototype);

KONOHA.ResearchPlan.prototype.canStart = function(gameState)
{
...
KONOHA.ResearchPlan.prototype.getBestResearchers = function(gameState, noRequirementCheck = false)
{
...
KONOHA.ResearchPlan.prototype.isInvalid = function(gameState)
{
	return gameState.isResearched(this.type) || gameState.isResearching(this.type);
};

KONOHA.ResearchPlan.prototype.start = function(gameState)
{
...
KONOHA.ResearchPlan.prototype.onStart = function(gameState)
{
...
KONOHA.ResearchPlan.prototype.Serialize = function()
{
	return {
...
KONOHA.ResearchPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
