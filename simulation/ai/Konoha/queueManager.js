...
KONOHA.QueueManager = function(Config, queues)
{
	this.Config = Config;
	this.queues = queues;
	this.priorities = {};
...
KONOHA.QueueManager.prototype.getAvailableResources = function(gameState)
{
...
KONOHA.QueueManager.prototype.getTotalAccountedResources = function()
{
...
KONOHA.QueueManager.prototype.currentNeeds = function(gameState)
{
...
// TODO: many things.
KONOHA.QueueManager.prototype.wantedGatherRates = function(gameState)
{
...
KONOHA.QueueManager.prototype.printQueues = function(gameState)
{
	let numWorkers = 0;
...
KONOHA.QueueManager.prototype.clear = function()
{
	for (let i in this.queues)
		this.queues[i].empty();
};
 ...
 */
KONOHA.QueueManager.prototype.setAccounts = function(gameState, cost, i)
{
 ...
 */
KONOHA.QueueManager.prototype.transferAccounts = function(cost, i, j)
{
	for (let res of Resources.GetCodes())
	{
 ...
 */
KONOHA.QueueManager.prototype.distributeResources = function(gameState)
{
	...
	for (let res of Resources.GetCodes())
	{
		...
		if (available < 0)
			API3.warn("Konoha: problem with remaining " + res + " in queueManager " + available);
	}
};

KONOHA.QueueManager.prototype.switchResource = function(gameState, res)
{
...
KONOHA.QueueManager.prototype.startNextItems = function(gameState)
{
	for (let q of this.queueArrays)
	{
		let name = q[0];
...
KONOHA.QueueManager.prototype.update = function(gameState)
{
...
KONOHA.QueueManager.prototype.checkPausedQueues = function(gameState)
{
...
KONOHA.QueueManager.prototype.canAfford = function(queue, cost)
{
...
KONOHA.QueueManager.prototype.pauseQueue = function(queue, scrapAccounts)
{
...
KONOHA.QueueManager.prototype.unpauseQueue = function(queue)
{
	if (this.queues[queue])
		this.queues[queue].paused = false;
};

KONOHA.QueueManager.prototype.pauseAll = function(scrapAccounts, but)
{
	for (let q in this.queues)
	{
		if (q == but)
...
KONOHA.QueueManager.prototype.unpauseAll = function(but)
{
	for (let q in this.queues)
		if (q != but)
...
KONOHA.QueueManager.prototype.addQueue = function(queueName, priority)
{
	if (this.queues[queueName] !== undefined)
		return;

	this.queues[queueName] = new KONOHA.Queue();
...
KONOHA.QueueManager.prototype.removeQueue = function(queueName)
{
	if (this.queues[queueName] === undefined)
		return;
...
KONOHA.QueueManager.prototype.getPriority = function(queueName)
{
	return this.priorities[queueName];
};

KONOHA.QueueManager.prototype.changePriority = function(queueName, newPriority)
{
...
KONOHA.QueueManager.prototype.Serialize = function()
{
	let accounts = {};
	let queues = {};
	for (let q in this.queues)
...
KONOHA.QueueManager.prototype.Deserialize = function(gameState, data)
{
	...
	{
		this.queues[q] = new KONOHA.Queue();
