KONOHA.TrainingPlan = function(gameState, type, metadata, number = 1, maxMerge = 5)
{
...
KONOHA.TrainingPlan.prototype = Object.create(KONOHA.QueuePlan.prototype);

KONOHA.TrainingPlan.prototype.canStart = function(gameState)
{
...
KONOHA.TrainingPlan.prototype.getBestTrainers = function(gameState)
{
...
KONOHA.TrainingPlan.prototype.start = function(gameState)
{
	if (this.metadata && this.metadata.trainer)
	{
		let metadata = {};
...
KONOHA.TrainingPlan.prototype.addItem = function(amount = 1)
{
	this.number += amount;
};

/** Find the promoted types corresponding to this.type */
KONOHA.TrainingPlan.prototype.promotedTypes = function(gameState)
{
	let types = [];
...
KONOHA.TrainingPlan.prototype.Serialize = function()
{
	return {
...
KONOHA.TrainingPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
