CATILINA.ResearchPlan = function(gameState, type, rush = false)
{
	if (!CATILINA.QueuePlan.call(this, gameState, type, {}))
		return false;
...
CATILINA.ResearchPlan.prototype = Object.create(CATILINA.QueuePlan.prototype);

CATILINA.ResearchPlan.prototype.canStart = function(gameState)
{
...
CATILINA.ResearchPlan.prototype.getBestResearchers = function(gameState, noRequirementCheck = false)
{
...
CATILINA.ResearchPlan.prototype.isInvalid = function(gameState)
{
	return gameState.isResearched(this.type) || gameState.isResearching(this.type);
};

CATILINA.ResearchPlan.prototype.start = function(gameState)
{
...
CATILINA.ResearchPlan.prototype.onStart = function(gameState)
{
...
CATILINA.ResearchPlan.prototype.Serialize = function()
{
	return {
...
CATILINA.ResearchPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
