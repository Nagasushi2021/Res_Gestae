...
CATILINA.QueueManager = function(Config, queues)
{
	this.Config = Config;
	this.queues = queues;
	this.priorities = {};
...
CATILINA.QueueManager.prototype.getAvailableResources = function(gameState)
{
...
CATILINA.QueueManager.prototype.getTotalAccountedResources = function()
{
...
CATILINA.QueueManager.prototype.currentNeeds = function(gameState)
{
...
// TODO: many things.
CATILINA.QueueManager.prototype.wantedGatherRates = function(gameState)
{
...
CATILINA.QueueManager.prototype.printQueues = function(gameState)
{
	let numWorkers = 0;
...
CATILINA.QueueManager.prototype.clear = function()
{
	for (let i in this.queues)
		this.queues[i].empty();
};
 ...
 */
CATILINA.QueueManager.prototype.setAccounts = function(gameState, cost, i)
{
 ...
 */
CATILINA.QueueManager.prototype.transferAccounts = function(cost, i, j)
{
	for (let res of Resources.GetCodes())
	{
 ...
 */
CATILINA.QueueManager.prototype.distributeResources = function(gameState)
{
	...
	for (let res of Resources.GetCodes())
	{
		...
		if (available < 0)
			API3.warn("Catilina: problem with remaining " + res + " in queueManager " + available);
	}
};

CATILINA.QueueManager.prototype.switchResource = function(gameState, res)
{
...
CATILINA.QueueManager.prototype.startNextItems = function(gameState)
{
	for (let q of this.queueArrays)
	{
		let name = q[0];
...
CATILINA.QueueManager.prototype.update = function(gameState)
{
...
CATILINA.QueueManager.prototype.checkPausedQueues = function(gameState)
{
...
CATILINA.QueueManager.prototype.canAfford = function(queue, cost)
{
...
CATILINA.QueueManager.prototype.pauseQueue = function(queue, scrapAccounts)
{
...
CATILINA.QueueManager.prototype.unpauseQueue = function(queue)
{
	if (this.queues[queue])
		this.queues[queue].paused = false;
};

CATILINA.QueueManager.prototype.pauseAll = function(scrapAccounts, but)
{
	for (let q in this.queues)
	{
		if (q == but)
...
CATILINA.QueueManager.prototype.unpauseAll = function(but)
{
	for (let q in this.queues)
		if (q != but)
...
CATILINA.QueueManager.prototype.addQueue = function(queueName, priority)
{
	if (this.queues[queueName] !== undefined)
		return;

	this.queues[queueName] = new CATILINA.Queue();
...
CATILINA.QueueManager.prototype.removeQueue = function(queueName)
{
	if (this.queues[queueName] === undefined)
		return;
...
CATILINA.QueueManager.prototype.getPriority = function(queueName)
{
	return this.priorities[queueName];
};

CATILINA.QueueManager.prototype.changePriority = function(queueName, newPriority)
{
...
CATILINA.QueueManager.prototype.Serialize = function()
{
	let accounts = {};
	let queues = {};
	for (let q in this.queues)
...
CATILINA.QueueManager.prototype.Deserialize = function(gameState, data)
{
	...
	{
		this.queues[q] = new CATILINA.Queue();
