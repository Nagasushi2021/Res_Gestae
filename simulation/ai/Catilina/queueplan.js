...
CATILINA.QueuePlan = function(gameState, type, metadata)
{
	...
	if (!this.template)
	{
		API3.warn("Tried to add the inexisting template " + this.type + " to Catilina.");
		return false;
	}
...
CATILINA.QueuePlan.prototype.isInvalid = function(gameState)
{
	return false;
};

/** if true, the queue manager will begin increasing this plan's account. */
CATILINA.QueuePlan.prototype.isGo = function(gameState)
{
	return true;
};

/** can we start this plan immediately? */
CATILINA.QueuePlan.prototype.canStart = function(gameState)
{
	return false;
};

/** process the plan. */
CATILINA.QueuePlan.prototype.start = function(gameState)
{
	// should call onStart.
};

CATILINA.QueuePlan.prototype.getCost = function()
{
 ...
 */
CATILINA.QueuePlan.prototype.onStart = function(gameState)
{
};
